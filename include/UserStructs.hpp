...
struct FilmStatisticsEvalConfig {
    ...
    size_t entropy_window_size = 10;                ///< Window size for calculating mean entropy over time
    size_t entropy_variance_window_size = 10;       ///< Window size for entropy variance calculation (0 = disabled)
